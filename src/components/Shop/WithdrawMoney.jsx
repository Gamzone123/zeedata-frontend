...
const WithdrawMoney = () => {
  ...
  const deleteHandler = async () => {
    await axios
      .delete(`${server}/api/v2/shop/delete-withdraw-method`,  { headers: {
        "x-access-token": localStorage.getItem("seller_token"),
      },})
      .then((res) => {
  ...
  const withdrawHandler = async () => {
    if (withdrawAmount < 2000 || withdrawAmount > availableBalance) {
      toast.error("Minimum Withdraw amount is 2000. You can't withdraw this amount!.");
    } else {
